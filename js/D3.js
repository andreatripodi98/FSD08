...
let somma = 0;
for (let i = 0; i < starWarsCharacters.length; i++) {
  somma = somma + Number(starWarsCharacters[i].mass);
}
console.log("La massa totale è: " + somma);
/* ESERCIZIO 7
...
let character = starWarsCharacters[randomCharacter];

console.log(
  "My character choice is: " +
    character.name +
    " and their height is " +
    character.height +
    " their weight is " +
